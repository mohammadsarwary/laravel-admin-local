    ...
    <div class="flex h-screen overflow-hidden">
        ...
        >
            ...
            <nav class="mt-6 space-y-1">
                ...
                <a href="{{ route('admin.web.sliders') }}"
                   class="flex items-center px-4 py-3 mx-2 rounded-lg transition-colors {{ request()->routeIs('admin.web.sliders') ? 'bg-red-500 text-white' : 'text-gray-300 hover:bg-gray-700' }}">
                    <span class="material-icons text-xl">slideshow</span>
                    <span class="ml-3" x-show="sidebarOpen">Sliders</span>
                </a>
